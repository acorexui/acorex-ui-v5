...
@Component({
  templateUrl: './searchbar-selectbox-editor.html'
})
export class AXSearchBarSelectBoxEditorComponent extends AXProperyEditorComponent<any> {
  ...
  returnAllData: boolean = false;
  validation: AXValidation;

  @ViewChild(AXSelectBoxComponent, { static: false })
